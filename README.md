...
**Safari-extensie die commerciele advertenties verbergt op Marktplaats.nl**
...
MP Blocker respecteert je privacy volledig:

- Alle verwerking gebeurt lokaal op jouw apparaat
- Er worden geen gegevens verzameld, opgeslagen of verstuurd
...
**Werkt MP Blocker ook op andere websites?**
Nee, MP Blocker werkt alleen op Marktplaats.nl.

**Worden mijn gegevens gedeeld?**
Nee. MP Blocker verwerkt geen persoonsgegevens en verstuurt geen data.

**De extensie lijkt niet te werken. Wat kan ik doen?**
Controleer of de extensie is ingeschakeld in Safari-instellingen. Marktplaats kan hun website-structuur wijzigen waardoor de extensie tijdelijk niet werkt. Meld dit via een issue op deze pagina.

## Support

Heb je een probleem of suggestie? Maak een [issue](https://github.com/TVheld/mp-blocker/issues) aan op deze pagina.
